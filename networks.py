...
class LatentEncoder(nn.Module):
    def __init__(self, nlatent, input_nc, nef, norm_layer, gpu_ids=[]):
        ...
        self.enc_mu = nn.Conv2d(8*nef, nlatent, kernel_size=5, stride=1, padding=0, bias=True)
        self.enc_logvar = nn.Conv2d(8*nef, nlatent, kernel_size=5, stride=1, padding=0, bias=True)
